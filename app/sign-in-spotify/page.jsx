  ...
  return (
    <div className="font-sans bg-gradient-to-b from-[#1F1B20] to-[#0F581E] text-white flex flex-col items-center min-h-screen"
		...
		<header className="w-full fixed top-0 left-0 z-50">
			<nav className="bg-[#2D9944] rounded-full p-4 mt-4 mx-auto shadow-lg flex justify-center items-center w-full sm:w-fit">
				<ul className="flex gap-10 list-none p-0 m-0 flex-wrap justify-center">
					<li>
		...
		{/* Contenido Principal */}
		<main className="mt-20 px-4 w-full sm:w-[75%] text-center">
			<div className="flex pt-24 pb-16 px-24 sm:px-4">
				<img src="/image_spotify/spotify_icon_grande.svg" alt="email" className="w-full sm:w-auto" />
				<div className="flex flex-col items-center justify-center ml-[435px] sm:ml-0">
			...
			<div className="flex items-center justify-center">
				<button
					...
					className="w-full sm:w-2/6 p-3 py-5 bg-white rounded-3xl hover:bg-indigo-100"
				>
