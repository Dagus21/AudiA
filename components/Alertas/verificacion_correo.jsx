...
const ValidacionCorreo = ({ setMostrarValidacionCorreo }) => {
  
  const handleClose = () => {
    setMostrarValidacionCorreo(false); // Cerrar alerta
  };
  ...
  return (
    <div className="relative bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800 p-6 rounded-lg shadow-lg w-1/3 mx-auto flex items-start space-x-4">
      ...
      <div className="flex-1">
        <h1 className="text-lg font-semibold">Aun no has verificado tu cuenta</h1>
      </div>
