...
const ValidacionConfirmarContraseña = ({ setMostrarValidacionConfirmarContraseña }) => {
  
  const handleClose = () => {
    setMostrarValidacionConfirmarContraseña(false); // Cerrar alerta
  };
  ...
  return (
    <div className="relative bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800 
      ...
      <div className="flex-1 text-center sm:text-left">
        <h1 className="text-lg font-semibold">Las contraseñas no coinciden</h1>
      </div>
...
export default ValidacionConfirmarContraseña;
